...
void fluke_start(){
    idleLeft = create_animation("res/fighters/fluke/idle_left", 15);
    idleRight = create_animation("res/fighters/fluke/idle_right", 15);
    walkLeft = create_animation("res/fighters/fluke/walk_left", 15);
    walkRight = create_animation("res/fighters/fluke/walk_right", 15);
    crouchLeft = create_animation("res/fighters/fluke/crouch_left", 15);
    crouchRight = create_animation("res/fighters/fluke/crouch_right", 15);
    jumpLeft = create_animation("res/fighters/fluke/jump_left", 15);
    jumpRight = create_animation("res/fighters/fluke/jump_right", 15);
    lightPunchLeft = create_animation("res/fighters/fluke/light_punch_left", 20);
    lightPunchRight = create_animation("res/fighters/fluke/light_punch_right", 20);
    heavyPunchLeft = create_animation("res/fighters/fluke/heavy_punch_left", 20);
    heavyPunchRight = create_animation("res/fighters/fluke/heavy_punch_right", 20);
    blockStandLeft = create_animation("res/fighters/fluke/block_stand_left", 10);
    blockStandRight = create_animation("res/fighters/fluke/block_stand_right", 10);
    blockCrouchLeft = create_animation("res/fighters/fluke/block_crouch_left", 10);
    blockCrouchRight = create_animation("res/fighters/fluke/block_crouch_right", 10);
    lowPunchLeft = create_animation("res/fighters/fluke/low_punch_left", 20);
    lowPunchRight = create_animation("res/fighters/fluke/low_punch_right", 20);
    skill1Left = create_animation("res/fighters/fluke/skill1_left", 25);
    skill1Right = create_animation("res/fighters/fluke/skill1_right", 25);
    skill2Left = create_animation("res/fighters/fluke/skill2_left", 25);
    skill2Right = create_animation("res/fighters/fluke/skill2_right", 25);
    skill3Left = create_animation("res/fighters/fluke/skill3_left", 25);
    skill3Right = create_animation("res/fighters/fluke/skill3_right", 25);
    ultimateLeft = create_animation("res/fighters/fluke/ultimate_left", 30);
    ultimateRight = create_animation("res/fighters/fluke/ultimate_right", 30);
